...
zend_class_entry *utils_fileut_ce;
zend_class_entry *utils_rqueue_ce;
zend_class_entry *utils_stringut_ce;
...
static PHP_MINIT_FUNCTION(utils)
{
	...
	ZEPHIR_INIT(Utils_FileUt);
	ZEPHIR_INIT(Utils_RQueue);
	ZEPHIR_INIT(Utils_StringUt);
	return SUCCESS;
}
